    ...
    <section className="bg-background py-4 md:py-6 font-sans overflow-hidden">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="flex flex-col gap-6 md:gap-8">
          ...
          {/* Avatars */}
          <motion.div 
            className='flex flex-wrap gap-1 items-center justify-start -mt-5 -mb-2.5'
          ...
          >
            {avatarText ? (
              <div className='flex flex-wrap gap-1 items-center'>
                <span className='text-primary text-sm md:text-lg font-medium'>Over</span>
                <div className="*:data-[slot=avatar]:ring-background flex -space-x-2 *:data-[slot=avatar]:ring-2 mx-1">
                  <Avatar>
                ...
                <span className='text-primary text-sm md:text-lg font-medium whitespace-nowrap'>people have already</span>
                <span className='text-primary text-sm md:text-lg font-medium'>achieved their fitness goals this way.</span>
              </div>
            ) : (
              <>
                ...
                <p className='text-primary text-sm md:text-lg font-medium'>Already Achieved Their fitness goal</p>
              </>
            )}
          </motion.div>
